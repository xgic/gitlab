...
- Grok always produces clean professional draft artifacts (Draft PRs carrying explicit short "Review and approval per AGENTS.md and BASE-STANDARDS-FOR-ORCHESTRATED-REPOS.md." reference in the body) and pauses for approval after every remote action proposal.
