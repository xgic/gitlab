...
**Always positive framing. Strict GitHub Flow. xde for container tasks. Review gate on everything to main.**
...
- **Attribution**: Use @username for specific platform actions (e.g., "merged by @xgic via GitHub web UI").
...
8. Reviewer approves in GitHub UI.
...
- Explicit LGTM before the commit lands and before any remote action.
...
- Approval required on the release PR / tag.
